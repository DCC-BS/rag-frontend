...
<template>
    <div class="flex flex-col items-center justify-center space-y-8 p-8 min-h-[60vh]">
        ...
        <div class="text-center max-w-2xl mx-auto">
            <div class="mb-6">
                <div
                    class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl shadow-lg mb-4">
        ...
        <div class="w-full max-w-4xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div v-for="(question, index) in exampleQuestions" :key="index" class="group relative">
                    <button @click="handleQuestionClick(question.text)"
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div
                                class="p-2 bg-gray-100 dark:bg-gray-700 rounded-lg group-hover:bg-blue-100 dark:group-hover:bg-blue-900 transition-colors">
                                <UIcon :name="question.icon"
                        ...
                        <div class="space-y-2">
                            ...
                            <div
                                class="flex items-center text-xs text-gray-500 dark:text-gray-400 opacity-0 group-hover:opacity-100 transition-opacity">
